 ...
 * 
 */
@WebServiceClient(name = "HelloWebServiceImplService", targetNamespace = "http://ws.ponamorev.penzgtu.ru/", wsdlLocation = "http://localhost:1986/wss/hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOWEBSERVICEIMPLSERVICE_QNAME = new QName("http://ws.ponamorev.penzgtu.ru/", "HelloWebServiceImplService");
    ...
    public HelloWebService getHelloWebServiceImplPort() {
        return super.getPort(new QName("http://ws.ponamorev.penzgtu.ru/", "HelloWebServiceImplPort"), HelloWebService.class);
    }
    ...
    public HelloWebService getHelloWebServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.ponamorev.penzgtu.ru/", "HelloWebServiceImplPort"), HelloWebService.class, features);
    }
